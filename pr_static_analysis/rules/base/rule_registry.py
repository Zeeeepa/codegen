...
class RuleRegistry:
    ...
    def get_rules_by_category(self, category: RuleCategory) -> Dict[str, Type[BaseRule]]:
        ...
        return {
            ...
            if rule_class.category == category
        }
    ...
    def resolve_dependencies(self, rule_ids: List[str]) -> List[str]:
        ...
        for rule_id in rule_ids:
            ...
            if rule_class:
                graph[rule_id] = rule_class.dependencies
        ...
        def visit(node: str) -> None:
            ...
            if node in temp_marks:
                raise ValueError(f"Circular dependency detected involving rule '{node}'")
