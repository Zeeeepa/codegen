...
export { foo as renamed } from './other';
    ...
    with get_codebase_session(
        ...
        assert (
            exports[0].get_import_string(alias="myFoo")
            == "import { foo as myFoo } from 'test';"
        )
        assert (
            exports[0].get_import_string(import_type=ImportType.WILDCARD)
        ...
        assert (
            exports[1].get_import_string(alias="myBar") == "import myBar from 'test';"
        )

        # Test reexport
        assert (
            exports[2].get_import_string()
            == "import { foo as renamed } from './other';"
        )
...
export interface MyInterface {}
    ...
    with get_codebase_session(
        ...
        assert (
            exports[0].get_import_string(is_type_import=True)
            == "import type { MyType } from 'test';"
        )
        assert (
            exports[1].get_import_string(is_type_import=True)
            == "import type { MyInterface } from 'test';"
        )
...
export { ValueB, type TypeB } from './mixed';
    ...
    with get_codebase_session(
        ...
        assert (
            exports[0].get_import_string() == "import { $special_name$ } from 'test';"
        )
        ...
        assert (
            exports[3].get_import_string() == "import { foo as bar } from './circular';"
        )
        assert (
            exports[4].get_import_string() == "import { bar as foo } from './circular';"
        )

        # Test nested namespaces
        assert exports[5].get_import_string() == "import * as nested from './a';"
        assert (
            exports[6].get_import_string() == "import { nested as inner } from './b';"
        )

        # Test complex type exports
        assert (
            exports[7].get_import_string(is_type_import=True)
            == "import type { Type1 as default } from './types';"
        )
        assert (
            exports[8].get_import_string(is_type_import=True)
            == "import type { default as Type2 } from './types';"
        )

        # Test mixed exports
        assert (
            exports[9].get_import_string()
            == "import { type TypeA, ValueA } from './mixed';"
        )
        assert (
            exports[11].get_import_string()
            == "import { ValueB, type TypeB } from './mixed';"
        )
