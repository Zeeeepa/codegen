	...
	const handleFetchRepo = async () => {
		...
		try {
			...
			const response = await fetch(
				"https://codegen-sh--analytics-app-fastapi-modal-app.modal.run/analyze_repo",
				{
					method: "POST",
					headers: {
			...
			alert(
				"Error fetching repository data. Please check the URL and try again.",
			);
					...
					<main className="p-6 flex-grow">
						<div className="grid mb-5 gap-6 grid-cols-1">
							<Card>
								...
								<CardContent>
									<a
										href={`https://github.com/${repoData.name}`}
										target="_blank"
										rel="noopener noreferrer"
										className="block"
									>
						...
						<div className="grid gap-6 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4">
							<Card
								onMouseEnter={() => handleMouseEnter("Maintainability Index")}
							...
							>
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "Maintainability Index"
											? "This evaluates how easy it is to understand, modify, and maintain a codebase (ranging from 0 to 100)."
											: "Code maintainability score (0-100)"}
									</p>
								</CardContent>
							</Card>
							<Card
								onMouseEnter={() => handleMouseEnter("Cyclomatic Complexity")}
								onMouseLeave={handleMouseLeave}
							>
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
									<CardTitle className="text-sm font-medium">
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "Cyclomatic Complexity"
							...
							<Card
								onMouseEnter={() => handleMouseEnter("Halstead Volume")}
								onMouseLeave={handleMouseLeave}
							>
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
									<CardTitle className="text-sm font-medium">
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "Halstead Volume"
											? "This quantifies the amount of information in a program by measuring the size and complexity of its code using operators and operands."
											: "Code volume metric"}
									</p>
								</CardContent>
							</Card>
							<Card
								onMouseEnter={() => handleMouseEnter("Depth of Inheritance")}
								onMouseLeave={handleMouseLeave}
							>
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
									<CardTitle className="text-sm font-medium">
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "Depth of Inheritance"
											? "This is the average measure of the number of classes that a class inherits from."
											: "Average inheritance depth"}
									</p>
								</CardContent>
							</Card>
							<Card
								onMouseEnter={() => handleMouseEnter("Lines of Code")}
								onMouseLeave={handleMouseLeave}
							>
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
									<CardTitle className="text-sm font-medium">
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "Lines of Code"
											? "This is the total number of lines of code within this codebase."
											: "Total lines in the repository"}
									</p>
								</CardContent>
							</Card>
							<Card
								onMouseEnter={() => handleMouseEnter("SLOC")}
								onMouseLeave={handleMouseLeave}
							>
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "SLOC"
											? "This is the number of textual lines of code within the codebase, ignoring whitespace and comments."
											: "Source Lines of Code"}
									</p>
								</CardContent>
							</Card>
							<Card
								onMouseEnter={() => handleMouseEnter("LLOC")}
								onMouseLeave={handleMouseLeave}
							>
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "LLOC"
											? "This is the number of lines of code that contribute to executable statements in the codebase."
											: "Logical Lines of Code"}
									</p>
								</CardContent>
							</Card>
							<Card
								onMouseEnter={() => handleMouseEnter("Comment Density")}
								onMouseLeave={handleMouseLeave}
							>
								<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
									<CardTitle className="text-sm font-medium">
								...
								<CardContent>
									...
									<p className="text-xs text-muted-foreground mt-1">
										{hoveredCard === "Comment Density"
											? "This is the percentage of the lines in the codebase that are comments."
