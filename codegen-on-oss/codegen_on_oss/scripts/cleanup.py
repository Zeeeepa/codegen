...
def cleanup_files(dry_run=False):
    ...
    Args:
        dry_run: If True, only print the files that would be removed without actually removing them
    
    Returns:
        list: List of files that were removed or would be removed in dry run mode
    """
...
def main():
    ...
    parser.add_argument("--dry-run", action="store_true", help="Print files to be removed without removing them")
