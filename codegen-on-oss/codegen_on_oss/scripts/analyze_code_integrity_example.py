...
Example usage:
    # Basic analysis
    python -m codegen_on_oss.scripts.analyze_code_integrity_example \
    ...
    # Branch comparison
    python -m codegen_on_oss.scripts.analyze_code_integrity_example \
        --repo /path/to/repo --mode compare \
        --main-branch main --feature-branch feature \
        --output comparison.json --html report.html

    # PR analysis
    python -m codegen_on_oss.scripts.analyze_code_integrity_example \
        --repo /path/to/repo --mode pr \
        --main-branch main --feature-branch pr-branch \
        --output pr_analysis.json --html report.html
"""
...
def main():
    ...
    if args.mode == "single":
        ...
        results = analyze_branch_comparison(
