...
class RepoAnalysisRequest(BaseModel):
    ...
    def get_sanitized_github_token(self) -> Optional[str]:
        """Get the sanitized GitHub token."""
        return sanitize_github_token(self.github_token)
...
def create_app() -> FastAPI:
    ...
    @app.get("/get_snapshot/{snapshot_id}")
    ...
    @app.get("/get_preference/{user_id}/{preference_key}")
