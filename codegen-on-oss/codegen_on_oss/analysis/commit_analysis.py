...
class CommitAnalysisResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {"commit_hash": self.commit_hash, "author": self.author, "date": self.date, "message": self.message, "files_changed": [file.to_dict() for file in self.files_changed]}
...
class CommitComparisonResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Convert the result to a dictionary."""
        return {"base_commit_hash": self.base_commit_hash, "compare_commit_hash": self.compare_commit_hash, "files_changed": [file.to_dict() for file in self.files_changed]}
