...
def main():
    ...
    complex_functions = [f for f in complexity_results["cyclomatic_complexity"]["functions"] if f["complexity"] > 10][:5]  # Show top 5
    ...
    print(f"Dependency graph: {dependencies['dependency_graph']['nodes']} nodes, {dependencies['dependency_graph']['edges']} edges")
