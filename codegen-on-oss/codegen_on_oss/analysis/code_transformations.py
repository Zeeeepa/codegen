...
def convert_all_calls_to_kwargs(
    ...
    try:
                    ...
                    for call in statement.function_calls:
                        try:
                            ...
                            if convert_call_to_kwargs(call, function_def):
                                ...
                                failed_conversions.append(f"{call.name} at {file.path}:{function.start_line}")
                        except Exception as e:
        ...
        logger.info(f"Skipped {skipped_count} function calls (already using kwargs or not in target list)")
