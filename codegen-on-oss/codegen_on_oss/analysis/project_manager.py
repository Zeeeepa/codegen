...
class Project:
    ...
    def __init__(self, repo_url: str, name: str, description: Optional[str] = None, default_branch: str = "main"):
...
class ProjectManager:
    ...
    def register_project(self, repo_url: str, name: str, description: Optional[str] = None, default_branch: str = "main") -> Project:
        ...
        """
        project = Project(repo_url=repo_url, name=name, description=description, default_branch=default_branch)
