...
class DiffAnalyzer:
    ...
    def analyze_function_changes(self) -> Dict[str, str]:
        ...
        for func_name in common_functions:
            ...
            elif (original_func['parameter_count'] != modified_func['parameter_count'] or
                  original_func['line_count'] != modified_func['line_count'] or
                  original_func['cyclomatic_complexity'] != modified_func['cyclomatic_complexity']):
    ...
    def analyze_class_changes(self) -> Dict[str, str]:
        ...
        for class_name in common_classes:
            ...
            elif (original_class['method_count'] != modified_class['method_count'] or
                  original_class['attribute_count'] != modified_class['attribute_count'] or
                  original_class['parent_class_count'] != modified_class['parent_class_count']):
    ...
    def analyze_complexity_changes(self) -> Dict[str, Dict[str, Any]]:
        ...
        common_functions = [
            func_name for func_name, change_type in function_diffs.items()
    ...
    def get_detailed_file_diff(self, filepath: str) -> Optional[List[str]]:
        ...
        if (filepath not in self.original.file_metrics or 
            filepath not in self.modified.file_metrics):
            return None
