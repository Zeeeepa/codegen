...
class ProjectManager:
    ...
    def register_project(
        self, project_url: str, project_name: Optional[str] = None
    ) -> Dict[str, Any]:
        """
...
class WebhookHandler:
    ...
    def register_webhook(
        self, project_id: str, webhook_url: str, events: List[str]
    ) -> Dict[str, Any]:
        """
    ...
    def trigger_webhook(
        self, project_id: str, event: str, payload: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
