...
class ImplementationValidationRule(BaseRule):
    ...
    def analyze(self, context: AnalysisContext) -> Dict[str, Any]:
        ...
        try:
            ...
            issues.append(self.create_issue(
                message=f"Error analyzing diff: {str(e)}",
                severity="error"
            ))
        ...
        try:
            ...
            issues.append(self.create_issue(
                message=f"Error analyzing commits: {str(e)}",
                severity="error"
            ))
    ...
    def _analyze_diff(self, context: AnalysisContext, diff_analyzer: DiffAnalyzer) -> List[Dict[str, Any]]:
        """
    ...
    def _analyze_commits(self, context: AnalysisContext, commit_analyzer: CommitAnalyzer) -> List[Dict[str, Any]]:
        """
