...
class CommitAnalyzer:
    ...
    def analyze_commit(self, repo_url: str, base_commit: str, head_commit: str) -> Dict[str, Any]:
        """
...
def analyze_commit_from_paths(original_path: str, commit_path: str) -> CommitAnalysisResult:
    """
