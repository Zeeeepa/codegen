...
class CodebaseContext:
    ...
    def get_directory(self, path: str | Path) -> Directory | None:
        """
        ...
        for file in self._file_cache.values():
            if hasattr(file, "imports"):
                for import_item in file.imports:
                    ...
                    if (
                        hasattr(import_item, "resolved_symbol")
                        and import_item.resolved_symbol
                    ):
                        ...
                        for symbol in self.codebase.symbols:
                            if (
                                hasattr(symbol, "name")
                                and symbol.name == import_item.name
                            ):
    ...
    def get_node(self, id_or_obj: Any) -> Any | None:
        """
    ...
    def get_nodes(self, node_type: Any | None = None) -> list[Any]:
        """
    ...
    def get_file(self, path: str | Path) -> SourceFile | None:
        """
    ...
    def _get_raw_file_from_path(self, path: str) -> SourceFile | None:
        """
    ...
    def get_external_module(self, name: str) -> Any | None:
        """
    ...
    def add_edge(self, u: Any, v: Any, edge_type: Any | None = None) -> None:
        """
    ...
    def predecessor(self, node: Any) -> Any | None:
        """
    ...
    def to_absolute(self, path: str | Path) -> str:
        """
    ...
    def is_subdir(self, parent: str | Path, child: str | Path) -> bool:
        """
    ...
    def add_single_file(self, path: str, content: str) -> SourceFile | None:
        """
    ...
    @property
    def ts_declassify(self) -> Callable | None:
