...
class TestChangeType(unittest.TestCase):
    def test_from_watch_change_type_added(self):
        self.assertEqual(ChangeType.from_watch_change_type(Change.added), ChangeType.Added)

    def test_from_watch_change_type_deleted(self):
        self.assertEqual(ChangeType.from_watch_change_type(Change.deleted), ChangeType.Removed)

    def test_from_watch_change_type_modified(self):
        self.assertEqual(ChangeType.from_watch_change_type(Change.modified), ChangeType.Modified)
