...
This module provides functions for analyzing call chains between functions in a codebase.
"""
...
def get_call_chain_analysis(codebase) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        for function in codebase.functions:
            function_name = f"{function.file.file_path}::{function.name}" if hasattr(function, "file") else f"unknown::{function.name}"
