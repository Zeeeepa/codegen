...
class ModuleDependencyGraph:
    ...
    def add_module(self, module: SourceFile | str, attributes: dict[str, Any] | None = None) -> None:
    ...
    def add_dependency(self, source_module: SourceFile | str, target_module: SourceFile | str, import_obj: Import | None = None, attributes: dict[str, Any] | None = None) -> None:
    ...
    def detect_circular_dependencies(self) -> list[list[str]]:
        ...
        try:
            ...
            logger.exception(f"Error detecting circular dependencies: {e}")
            return []
    ...
    def filter_by_depth(self, root_module: SourceFile | str, max_depth: int) -> ModuleDependencyGraph:
    ...
    def to_visualization_graph(self) -> DiGraph:
        ...
        for source, target, data in self.graph.edges(data=True):
            ...
            viz_graph.add_edge(source, target, width=edge_width, color=edge_color, tooltip=f"Imports: {weight}", **data)

        return viz_graph

    def to_json(self, root: SourceFile | str | Editable | None = None) -> str:
...
def build_module_dependency_graph(files: list[SourceFile], include_external: bool = False, path_filter: str | None = None) -> ModuleDependencyGraph:
