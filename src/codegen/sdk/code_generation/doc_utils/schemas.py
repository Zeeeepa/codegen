...
class MethodDoc(BaseModel):
    ...
    return_type: list[str] | None = Field(
        default=None, description="The return types of the method"
    )
    return_description: str | None = Field(
        default=None, description="The return description of the method"
    )
    method_type: Literal["method", "property", "attribute"] = Field(
        ..., description="The type of the method"
    )
    code: str = Field(..., description="The signature of the method or attribute")
    path: str = Field(
        ...,
        description="The path of the method that indicates its parent class <language>/<class_name>/<method_name>",
    )
    raises: list[dict] | None = Field(..., description="The raises of the method")
    metainfo: dict = Field(
        ..., description="Information about the method's true parent class and path"
    )
    version: str = Field(
        ..., description="The commit hash of the git commit that generated the docs"
    )
...
class ClassDoc(BaseModel):
    ...
    inherits_from: list[str] = Field(
        ..., description="The classes that the class inherits from"
    )
    version: str = Field(
        ..., description="The commit hash of the git commit that generated the docs"
    )
    methods: list[MethodDoc] = Field(default=[], description="The methods of the class")
    attributes: list[MethodDoc] = Field(
        default=[], description="The attributes of the class"
    )
