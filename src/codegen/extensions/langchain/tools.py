...
class ViewFileInput(BaseModel):
    ...
    max_lines: Optional[int] = Field(None, description="Maximum number of lines to view at once, defaults to 1500")
...
For large files (>1500 lines), content will be paginated. Use start_line and end_line to navigate through the file.
