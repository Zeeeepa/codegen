...
This module provides functions for detecting dead code in a codebase with filtering options.
"""
...
def get_dead_code_detection_with_filtering(codebase, exclude_patterns: List[str] = None) -> Dict[str, Any]:
    """
