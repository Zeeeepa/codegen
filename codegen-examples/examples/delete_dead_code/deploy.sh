...
echo "Deploying Dead Code Deletion Tool to Modal..."
python3 run.py

echo "Deployment complete! You can check the status with 'modal app status delete-dead-code'"
echo "To view logs, run 'modal app logs delete-dead-code'"
