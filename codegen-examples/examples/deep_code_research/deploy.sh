...
echo "Deploying Deep Code Research to Modal..."
python3 run.py

echo "Deployment complete! You can check the status with 'modal app status deep-code-research'"
echo "To view logs, run 'modal app logs deep-code-research'"
