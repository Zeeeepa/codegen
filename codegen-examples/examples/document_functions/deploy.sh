...
echo "Deploying Function Documentation Tool to Modal..."
python3 run.py

echo "Deployment complete! You can check the status with 'modal app status document-functions'"
echo "To view logs, run 'modal app logs document-functions'"
