...
echo "Deploying Modal Repo Analytics to Modal..."
python3 api.py

echo "Deployment complete! You can check the status with 'modal app status repo-analytics-api'"
echo "To view logs, run 'modal app logs repo-analytics-api'"
