 ...
 * IRIS-optimized with telemetry tracking
 */
 ...
 * IRIS-tracked AI function
 */
export const generateMcpJson = withTelemetry(
  function generateMcpJson(profile: ProfileAdvanced): string {
 ...
 * IRIS-tracked AI function
 */
export const generateAgentMarkdown = withTelemetry(
  function generateAgentMarkdown(profile: ProfileAdvanced): string | null {
    if (!profile.agent) {
      return null;
    }
 ...
 * IRIS-tracked AI function
 */
export const generateCommandMarkdowns = withTelemetry(
  function generateCommandMarkdowns(profile: ProfileAdvanced): Record<string, string> {
 ...
 * IRIS-tracked AI function
 */
export const generateReadme = withTelemetry(
  function generateReadme(profile: ProfileAdvanced): string {
    return `# ${profile.name}
